...
<?php include_once("views/template/header-principal.php"); ?>
      ...
      <div class="container">
        ...
        <div class="row check-availabilty" id="next">
          <div class="block-32" data-aos="fade-up" data-aos-offset="-200">
            ...
            <form id="formulario" action="<?php echo RUTA_PRINCIPAL . 'principal/verify'; ?>">
              <div class="row">
                <div class="col-md-3 mb-3 mb-lg-0 col-lg-3">
                  ...
                  <div class="field-icon-wrap">
                    ...
                    <input type="date" id="fecha_llegada" name="fecha_llegada" class="form-control" value="<?php echo date('Y-m-d'); ?>">
                    <!-- <input type="hidden" id="fecha_formateada" name="fecha_formateada"> -->
                  </div>
                </div>
                ...
                <div class="col-md-3 mb-3 mb-lg-0 col-lg-3">
                  ...
                  <div class="field-icon-wrap">
                    <div class="icon"><span class="icon-calendar"></span></div>
                    <input type="date" id="fecha_salida" name="fecha_salida" class="form-control" value="<?php echo date('Y-m-d'); ?>">
                  </div>
                </div>
                ...
                <div class="col-md-3 col-lg-3 align-self-end">
                  <button type="submit" class="btn btn-primary btn-block text-white">Comprobar</button>
                </div>
              </div>
            </form>
          </div>
        ...
        <div class="row align-items-center">
          <div class="col-md-12 col-lg-7 ml-auto order-lg-2 position-relative mb-5" data-aos="fade-up">
            <figure class="img-absolute">
              <img src="assets/principal/images/food-1.jpg" alt="Image" class="img-fluid">
            </figure>
            <img src="assets/principal/images/img_1.jpg" alt="Image" class="img-fluid rounded">
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4" data-aos="fade-up">
            <a href="#" class="room">
              <figure class="img-wrap">
                <img src="assets/principal/images/img_1.jpg" alt="Free website template" class="img-fluid mb-3">
              </figure>
          ...
          <div class="col-md-6 col-lg-4" data-aos="fade-up">
            <a href="#" class="room">
              <figure class="img-wrap">
                <img src="assets/principal/images/img_2.jpg" alt="Free website template" class="img-fluid mb-3">
              </figure>
              <div class="p-3 text-center room-info">
                <h2>Family Room</h2>
          ...
          <div class="col-md-6 col-lg-4" data-aos="fade-up">
            <a href="#" class="room">
              <figure class="img-wrap">
                <img src="assets/principal/images/img_3.jpg" alt="Free website template" class="img-fluid mb-3">
              </figure>
              <div class="p-3 text-center room-info">
          ...
          <div class="col-md-12">
            <div class="home-slider major-caousel owl-carousel mb-5" data-aos="fade-up" data-aos-delay="200">
              <div class="slider-item">
                <a href="assets/principal/images/slider-1.jpg" data-fancybox="images" data-caption="Caption for this image"><img src="assets/principal/images/slider-1.jpg" alt="Image placeholder" class="img-fluid"></a>
              </div>
              <div class="slider-item">
                <a href="assets/principal/images/slider-2.jpg" data-fancybox="images" data-caption="Caption for this image"><img src="assets/principal/images/slider-2.jpg" alt="Image placeholder" class="img-fluid"></a>
              </div>
              <div class="slider-item">
                <a href="assets/principal/images/slider-3.jpg" data-fancybox="images" data-caption="Caption for this image"><img src="assets/principal/images/slider-3.jpg" alt="Image placeholder" class="img-fluid"></a>
              </div>
              <div class="slider-item">
                <a href="assets/principal/images/slider-4.jpg" data-fancybox="images" data-caption="Caption for this image"><img src="assets/principal/images/slider-4.jpg" alt="Image placeholder" class="img-fluid"></a>
              </div>
              <div class="slider-item">
                <a href="assets/principal/images/slider-5.jpg" data-fancybox="images" data-caption="Caption for this image"><img src="assets/principal/images/slider-5.jpg" alt="Image placeholder" class="img-fluid"></a>
              </div>
              <div class="slider-item">
                <a href="assets/principal/images/slider-6.jpg" data-fancybox="images" data-caption="Caption for this image"><img src="assets/principal/images/slider-6.jpg" alt="Image placeholder" class="img-fluid"></a>
              </div>
              <div class="slider-item">
                <a href="assets/principal/images/slider-7.jpg" data-fancybox="images" data-caption="Caption for this image"><img src="assets/principal/images/slider-7.jpg" alt="Image placeholder" class="img-fluid"></a>
              </div>
            </div>
            <!-- END slider -->
          </div>
    ...
    <section class="section bg-image overlay" style="background-image: url('assets/principal/images/hero_3.jpg');">
      <div class="container">
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-7">
          ...
          <div class="js-carousel-2 owl-carousel mb-5" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="testimonial text-center slider-item">
              <div class="author-image mb-3">
                <img src="assets/principal/images/person_1.jpg" alt="Image placeholder" class="rounded-circle mx-auto">
              </div>
              <blockquote>
            ...
            <div class="testimonial text-center slider-item">
              <div class="author-image mb-3">
                <img src="assets/principal/images/person_2.jpg" alt="Image placeholder" class="rounded-circle mx-auto">
              </div>
              <blockquote>
            ...
            <div class="testimonial text-center slider-item">
              <div class="author-image mb-3">
                <img src="assets/principal/images/person_3.jpg" alt="Image placeholder" class="rounded-circle mx-auto">
              </div>
              <blockquote>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="media media-custom d-block mb-4 h-100">
              <a href="#" class="mb-4 d-block"><img src="assets/principal/images/img_1.jpg" alt="Image placeholder" class="img-fluid"></a>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="200">
            <div class="media media-custom d-block mb-4 h-100">
              <a href="#" class="mb-4 d-block"><img src="assets/principal/images/img_2.jpg" alt="Image placeholder" class="img-fluid"></a>
              <div class="media-body">
                <span class="meta-post">February 26, 2018</span>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="300">
            <div class="media media-custom d-block mb-4 h-100">
              <a href="#" class="mb-4 d-block"><img src="assets/principal/images/img_3.jpg" alt="Image placeholder" class="img-fluid"></a>
              <div class="media-body">
                <span class="meta-post">February 26, 2018</span>
    ...
    <section class="section bg-image overlay" style="background-image: url('assets/principal/images/hero_4.jpg');">
        <div class="container" >
          <div class="row align-items-center">
